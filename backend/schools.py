...
LESSON_KEYS = {"abc", "numbers", "shapes", "colors", "fruits", "drawing", "poems", "flags", "urdu", "arabic", "islamic", "science", "animals", "quiz"}
...
def create_student(db, bcrypt, cls, first, last, parent, created_by, password=None, extra=None):
    ...
    db.progress.insert_one({
        ...
        "completed_items": {k: [] for k in ("abc", "numbers", "shapes", "colors", "poems", "fruits", "flags", "urdu", "arabic", "islamic", "science", "animals")},
